    ...
    ?>
        <div class="phones"> 
            <div class="sec-container phones-wrapper">
                ...
                $sql1 = "SELECT p.p_id, p.title,p.image1,c.category_name FROM product p JOIN category c ON p.category = c.c_id WHERE c.category_name = 'iPhone' AND p.main = 1 LIMIT 5";
    ...
    <div style="background-color : #f5f5f7;text-align:center; ">
      <p style="padding:.5rem;font-size:.9rem;" class="sec-container">Delight your loved ones with perfect gifts from our store.&nbsp;<a href="index.php" style="text-decoration:none;">Store ></a></p>
        ...
        <div id="video-container" class="sec-container">
            <iframe loading="lazy" width="100%" height="100%" src="https://www.youtube.com/embed/eDqfg_LexCQ?si=x2aIyI6hx0dDfmMX&autoplay=1&mute=1&loop=1&controls=0&playlist=eDqfg_LexCQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    <div id="square-container" class="sec-container">
        ...
        <div id="square-wrapper">
            <div class="square-card card-1">
                ...
                <h4>AI-opening possibilities.</h4>
            </div>
            <div class="square-card card-2">
                <h6>Cutting-Edge Cameras</h6>
                <h4>Picture your best photos and videos.</h4>
            </div>
            <div class="square-card card-3">
                <h6>Chip and Battery Life</h6>
                <h4>Fast that lasts.</h4>
            </div>
            <div class="square-card card-4">
                <h6>Innovation</h6>
                <h4>Beutiful and durable, by design.</h4>
            </div>
            <div class="square-card card-5">
                <h6>Environment</h6>
                <h4>Recycle. Reuse. Repeat.</h4>
            </div>
        </div>
     ...
     <div id="products-container">
        ...
        <div id="product-wrapper">
            <?php 
                ...
                $sql = "SELECT p.p_id, p.title, p.description, p.image1, p.price, p.main, c.category_name FROM product p JOIN category c ON p.category = c.c_id WHERE c.category_name = 'iPhone' AND p.main = 1";
