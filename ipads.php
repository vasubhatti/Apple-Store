...
<head>
    ...
    <link rel="stylesheet" href="./css/ipads.css">
...
<body>
    ...
    ?>
    <div class="pads">
        <div class="sec-container pads-wrapper">
                <?php 
                include "config.php";

                $sql1 = "SELECT p.p_id, p.title,p.image1,c.category_name FROM product p JOIN category c ON p.category = c.c_id WHERE c.category_name = 'iPad' AND p.main = 1 LIMIT 5";
    ...
    <div style="background-color : #f5f5f7;text-align:center; ">
      <p style="padding:.5rem;font-size:.9rem;" class="sec-container">Delight your loved ones with perfect gifts from our store.&nbsp;<a href="index.php" style="text-decoration:none;">Store ></a></p>
        ...
        <div id="intro" class="sec-container">
            <h1>iPad</h1>
            <h4>Touch, draw and type<br>
on one magical device.</h4>
        </div>
        <div id="video-container" class="sec-container">
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/uhhnVcfdkoo?si=ieBaXU4L5r5pYhOp&autoplay=1&mute=1&loop=1&controls=0&playlist=uhhnVcfdkoo" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
    <div id="square-container" class="sec-container">
        ...
        <div id="square-wrapper">
            <div class="square-card card-1">
                ...
                <h4>Pesonal,private,powerful.</h4>
            </div>
            <div class="square-card card-2">
                <h6>Productivity</h6>
                <h4>Your workplace can be any place.</h4>
            </div>
            <div class="square-card card-3">
                <h6>Creativity</h6>
                <h4>Take your inner artist out and about.</h4>
            </div>
            <div class="square-card card-4">
                <h6>Learning</h6>
                <h4>Your classroom can be anywhere.</h4>
            </div>
            <div class="square-card card-5">
                <h6>Entertainment</h6>
                <h4>Kick back.Tune in.<br>Game on.</h4>
            </div>
            <div class="square-card card-6">
                <h6>Apple Pencil</h6>
                <h4>Dream it up.<br>Jot it down.</h4>
            </div>
            <div class="square-card card-7">
                <h6>iPadOS + Apps</h6>
                <h4>Everyday superpowers.<br>Built right in.</h4>
            </div>
        </div>
    ...
    <!-- ######### PRODUCTS ######### -->
        ...
        <div id="product-wrapper">
            <?php 
                ...
                $sql = "SELECT p.p_id, p.title, p.description, p.image1, p.price, p.main, c.category_name FROM product p JOIN category c ON p.category = c.c_id WHERE c.category_name = 'iPad' AND p.main = 1";
